<template>
    <div class="relative min-h-screen overflow-hidden bg-[#050505] text-white">
        ...
        <header
            class="absolute top-0 right-0 left-0 z-11 flex items-center justify-between px-6 py-6 lg:px-10"
        >
        ...
        <main
            class="relative z-10 flex min-h-screen items-center justify-center px-5 py-24"
        >
                ...
                >
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            <label
                                for="email"
                                class="mb-2 block text-xs font-medium text-white/60"
                            >
                                Email address
                            </label>
                        ...
                        <label
                            class="flex cursor-pointer items-center gap-2.5 text-xs text-white/35"
                        >
                            <input
                    ...
                    <div
                        class="mt-7 border-t border-white/[0.06] pt-6 text-center"
                    >
                        <p class="text-xs text-white/30">
                            ...
                            <Link
                                :href="route('register')"
                                class="ml-1 font-medium text-[#C9A227] hover:underline"
                            >
                                Create one
                            </Link>
                        </p>
