...
<template>
    <div class="mx-auto px-5 py-10 lg:px-8">
        ...
        <!-- No subscription -->
        <div v-if="!subscription" class="rounded-3xl border border-white/10 bg-white/[0.03] p-10 text-center">
            <Crown :size="40" class="mx-auto text-[#C9A227]" />
        ...
        <div v-else>
            ...
            <div class="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03]">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="rounded-full px-3 py-1 text-xs font-medium" :class="isCanceling
                ...
                <div class="grid gap-px bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="bg-[#0D0D0D] p-6">
                        ...
                        <div class="mt-2 font-medium" :class="isCanceling
                            ? 'text-orange-400'
                            : 'text-green-400'">
                ...
                <!-- Cancellation notice -->
                <div v-if="isCanceling" class="border-t border-orange-400/10 bg-orange-400/[0.04] px-7 py-5">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">

                        <div class="flex gap-3">

                            <AlertTriangle :size="20" class="mt-0.5 shrink-0 text-orange-400" />
                ...
                <div class="flex flex-col gap-3 border-t border-white/10 p-7 sm:flex-row">
                    ...
                    <button v-if="subscription.ends_at && subscription.status == 'active'"
                    ...
                    <button v-if="!isCanceling" @click="showCancelModal = true"
            ...
            <div class="mt-12">
                ...
                <div class="grid gap-5 md:grid-cols-3">
                    ...
                    <div v-for="plan in packages" :key="plan.id"
                        class="relative flex flex-col rounded-3xl border p-6 transition" :class="plan.id === currentPackage?.id
                            ? 'border-[#C9A227]/60 bg-[#C9A227]/[0.06]'
                            : 'border-white/10 bg-white/[0.03] hover:border-white/20'">

                        <span v-if="plan.id === currentPackage?.id"
                        ...
                        <div v-if="plan.features" class="mt-6 space-y-3">

                            <div v-for="(feature, index) in plan.features" :key="index"
                                class="flex gap-2 text-sm text-white/60">
                                <Check :size="16" class="mt-0.5 shrink-0 text-[#C9A227]" />
                        ...
                        <button v-if="plan.id !== currentPackage?.id" @click="changePlan(plan)"
    ...
    <div v-if="showChangeModal"
        ...
        <div class="w-full max-w-md rounded-3xl border border-white/10 bg-[#151515] p-7 shadow-2xl">
            ...
            <div v-if="selectedPackage" class="mt-5 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
