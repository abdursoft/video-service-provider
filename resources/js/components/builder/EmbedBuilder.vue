<template>
    <div class="overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0D0D0D]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)]">
            <!-- Sidebar -->
            <EmbedSidebar :active-tab="activeTab" @change="activeTab = $event" />
            ...
            <main class="min-w-0">
                <div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(320px,420px)]">
                    ...
                    <div class="min-h-[650px] border-b border-white/[0.08] p-5 sm:p-8 xl:border-r xl:border-b-0">
                        <AppearanceSettings v-if="activeTab === 'appearance'" v-model="player" />

                        <BrandingSettings v-if="activeTab === 'branding'" v-model="player" />

                        <ThumbnailSettings v-if="activeTab === 'thumbnail'" v-model="player" />

                        <PlaylistSettings v-if="activeTab === 'playlist'" v-model="player" />

                        <AdsSettings v-if="activeTab === 'ads'" v-model="player" />

                        <SourceSettings v-if="activeTab === 'source'" v-model="player" />

                        <PlaybackSettings v-if="activeTab === 'playback'" v-model="player" />

                        <ControlsSettings v-if="activeTab === 'controls'" v-model="player" />
...
import AdsSettings from '@/components/settings/AdsSettings.vue';
import AppearanceSettings from '@/components/settings/AppearanceSettings.vue';
import BrandingSettings from '@/components/settings/BrandingSettings.vue';
import ControlsSettings from '@/components/settings/ControlsSettings.vue';
...
import SubtitlesSettings from '@/components/settings/SubtitlesSettings.vue';
import ThumbnailSettings from '@/components/settings/ThumbnailSettings.vue';
